...
(function() {
    ...
    document.addEventListener('click', async (e) => {
        ...
        if (e.target.classList.contains('suggest-search')) {
            ...
            writeOutput(`<div class="output-line" style="margin:4px 0; display:flex; gap:8px;"><span class="prompt" style="color:#6ee7b7;">$</span> <span style="color:#94e6b2;">search ${escapeHtml(title)}</span></div>`);
    ...
    function showToast(msg) {
        ...
        toast.style.cssText = 'position:fixed; bottom:100px; right:20px; background:#2a6b47; color:white; padding:8px 16px; border-radius:8px; font-size:12px; z-index:9999; animation:fadeOut 2s forwards;';
